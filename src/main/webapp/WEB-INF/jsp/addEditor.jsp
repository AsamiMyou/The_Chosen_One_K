...
<body>
	<div class="wrap">
	  ...
	  <div class="mian">
    	...
    	<div>标题：<input type="text" name="title" style="float: right;width: 80%;height: 25px;" ></input></div>
    	<div>&nbsp;&nbsp;</div>
		<textarea name="content" cols="100" rows="8" style="width:1554px;height:400px;visibility:hidden;"></textarea>
		<br />
